...
# -----------------------------------------------------
    st.markdown("### 1️⃣ Company Hiring Performance")
...
# -----------------------------------------------------
    st.markdown("### 2️⃣ Company Package Analysis")
    ...
    # -----------------------------------------------------
    st.markdown("### 3️⃣ Branch-wise Company Preference")
    ...
    # -----------------------------------------------------
    st.markdown("### 4️⃣ Company Demand Analysis")
    ...
    # -----------------------------------------------------
    st.markdown("### 5️⃣ Company Difficulty Index")
    ...
    # -----------------------------------------------------
    st.markdown("### 6️⃣ Company Visit Trend")
    ...
    # -----------------------------------------------------
    st.markdown("### 7️⃣ Offer Acceptance Analysis")
    ...
    # -----------------------------------------------------
    st.markdown("### 8️⃣ Internship to PPO Conversion")
    ...
    # -----------------------------------------------------
    st.markdown("### 9️⃣ Company Retention")
    ...
    # -----------------------------------------------------
    st.markdown("### 1️⃣1️⃣ Interview Mode Analysis")
    ...
    # -----------------------------------------------------
    st.markdown("### 1️⃣2️⃣ Hiring Speed Analysis")
    ...
    # -----------------------------------------------------
    st.markdown("### 1️⃣3️⃣ Company Quality Score")
    ...
    # -----------------------------------------------------
    st.markdown("### 1️⃣4️⃣ Placement Coverage")
    ...
    # -----------------------------------------------------
    st.markdown("### 1️⃣5️⃣ Top Paying Companies")
...
with tabs[4]:
    ...
    with st.expander("➕ Register New Company Drive"):
        ...
        st.subheader("1️⃣ Basic Company Information")
        ...
        st.subheader("2️⃣ Job Role Details")
        ...
        st.subheader("3️⃣ Salary & Benefits")
        ...
        st.subheader("4️⃣ Eligibility Criteria")
        ...
        st.subheader("5️⃣ Selection Process")
        ...
        st.subheader("6️⃣ Recruitment Schedule")
        ...
        st.subheader("7️⃣ Documents Required")
        ...
        st.subheader("8️⃣ Placement Cell Internal Tracking")
